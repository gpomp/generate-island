      ...
      return new Promise((resolve, reject) => {
        loadTrees().then(() => {
          ...
          for (var i = 0; i < 500; i++) {
            ...
            pos.add(sub.subVectors(v0, pos).multiplyScalar(Math.random() * 0.5));
            pos.add(sub.subVectors(v1, pos).multiplyScalar(Math.random() * 0.5));
            pos.add(sub.subVectors(v2, pos).multiplyScalar(Math.random() * 0.5));
